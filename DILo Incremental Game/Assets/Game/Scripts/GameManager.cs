...
public class GameManager : MonoBehaviour
{
    ...
    // Fungsi [Range (min, max)] ialah menjaga value agar tetap berada di antara min dan max-nya dan membuat slider pada inspektor
    [Range(0f, 1f)]
    ...
    private void Update()
    {
        ...
        //interpolate coin saat diklik untuk kembali ke ukuran semula
